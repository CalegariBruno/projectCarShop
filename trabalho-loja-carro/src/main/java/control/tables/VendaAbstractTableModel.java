...
public class VendaAbstractTableModel extends AbstractTableModel{
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 1: return item.getVeiculo().getPlaca();
            case 2: return item.getVeiculo().getMarca();
            case 3: return item.getVeiculo().getModelo();
            case 4: return item.getData();
            case 5: return item.getValor();
            case 6: return item.getValorCompra();
            case 7: return item.getVeiculo().getValorTotalDespesas();
            case 8: return item.getLucro();
            default: return null;
        }
